...
* A LaTeX file with images in the subfolder: cannot be viewed in GitHub (which has no extensions), but TexStudio compiles and displays it. Also works with VScode LaTeX extensions, or with Overleaf (online).
